...
\begin{figure*}[h]
    ...
    \begin{tikzpicture}[scale=1]
        \hspace{-0.6cm}
        \node at (0,0) [anchor=south west] {\scalebox{1}{\input{titrerkurva2.pgf}}};
        \fill[color=yellow!70!red, fill opacity=0.2] (2.2,4.9) rectangle (15,3) node[anchor=north east, fill opacity=1] {\Large{Buffertintervall}};
    \end{tikzpicture}
