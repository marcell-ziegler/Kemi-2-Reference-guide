...
I uppgifter behöver man ofta bestämma hur en rekation kommer \emph{förskjutas} eller vilket håll den kommer ''gå mot''. Alla jämvikter vill till slut uppnå det jämviktsförhållande som är givet av deras $K$-värde under givna förhållanden. Om man börjar från ett tillstånd utan jämvikt eller om jämvikten rubbas kommer reaktionen att förskjutas. Detta innebär att antingen mängden reaktanter eller produkter kommer öka eller minska. När antalet produkter ökar jämfört med reaktanterna kallas det att reaktionen förskjuts åt vänster och motsatsen kallas förskjutning åt vänster.

\subsection{Reaktionskvoten}

Förhållandet mellan produkter och reaktanter när det inte råder jämvikt beskrivs av \emph{reaktionskvoten} $Q$. Formeln för $Q$ är exakt samma som för $K$. Vid jämvikt är $Q=K$ men övrigt är den skiljt från $K$. Reaktionskvoten brukar också användas när man resonerar om nya jämviktsförhållande som följd av en rubbning (dessa betecknas som $Q$ eller $K_{ny}$). Det finns två enkla regler angående $Q$-värdet\footnote{se s. 49--50 samt uppgift 3:9--3:10 i boken}:
\begin{align*}
    &Q > K \implies \text{fler produkter eller färre reaktanter} \implies \text{förskjutning åt vänster} \\
    &Q < K \implies \text{färre produkter eller fler reaktanter} \implies \text{förskjutning åt höger}
\end{align*}
...
\subsubsection*{Tillskott av reaktanter}
...
\subsubsection*{Tillskott av produkter}
...
Vid en reaktion som involverar ämnen i gasform kommer trycket att förändra värdet på $K$. Detta beror på \emph{ideala gaslagen}:
\begin{equation*}
    PV = nRT
\end{equation*}
...
\begin{equation*}
    C \propto \frac{1}{RT} \text{ med proportionalitetskonstanten } P
\end{equation*}
...
\begin{exm}
    ...
    \begin{equation*}
        V \to \frac{V}{2} \implies P \to 2P_0 \implies \frac{P_{ny}=2P_0}{P_0} = 2 = x
    \end{equation*}
    \begin{align*}
